        ...
        <table style="text-align: left; margin: 0 auto;color:#F08F01;font-size:11px;">
            ...
            <div id="lineaResultado">
			  <table class="fuente8" width="80%" cellspacing=0 cellpadding=3 border=0>
			  	<tr>
                                    <?php
                        $query_count = "select count(*) as total from categorias";
                        $result_count = mysql_query($query_count);
                        $total = mysql_fetch_array($result_count);
                    ?>
                                    <td width="50%" align="left">N de Equipos Encontrados <input id="filas" type="text" class="cajaPequena" NAME="filas" maxlength="5" readonly value="<?= $total['total']?>" style="text-align: center; font-size: 12px;"></td>
                                    ...
                                    <tr class="cabeceraTabla">
                                        ...
                                        <?php
                                            ...
                                            while($area = mysql_fetch_array($result)){?>
                                                <tr>
                                                    <td align="center"><?= $area['categoriascodigo']?></td>
                                                    <td align="center"><?= $area['categoriasdescripcion']?></td>
                                                    <td align="center"><?= $area['categoriasestado']?></td>
                                                    <td align="center">
