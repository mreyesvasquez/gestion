...
<!--            <fieldset id="datospersonalesP">
            ...
            <fieldset id="datospersonalesP">
                 <?php
                    ...
                    and i.categoriascodigo=c.categoriascodigo and i.incidenciasestado='EP' and personalasignado='$Codigopersonal'";
                    ...
                    <div id="ContieneTabla">
                        <table style="width: 100%;">
                            ...
                            <tr class="tr" style="background: #f0f0f0;">
                                <td class="td">
                                    <a href="IncidenciasTD.php?id=<?php echo $rsincidencias["incidenciascodigo"] ?>" onclick="$(this).modal({width:1033, height:583}).open(); return false;"><img src='../Imagenes/edi.gif' style="width: 20px; height: 20px"></a>
                                </td>
